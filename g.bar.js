...
(function () {
     ...
     * Vertical Barchart
     */
    function VBarchart(paper, x, y, width, height, values, opts, special_id) {
        opts = opts || {};
     ...
     * Horizontal Barchart
     */
    function HBarchart(paper, x, y, width, height, values, opts, special_id) {
        opts = opts || {};
    ...
    Raphael.fn.hbarchart = function(x, y, width, height, values, opts, special_id) {
        return new HBarchart(this, x, y, width, height, values, opts, special_id);
    };
    
    Raphael.fn.barchart = function(x, y, width, height, values, opts, special_id) {
        return new VBarchart(this, x, y, width, height, values, opts, special_id);
    };
})();
